...
/* CrunchJunkie badge — keep the dofollow link */
function CrunchJunkieBadge() {
  return (
    <a
      ...
      target="_blank"
      rel="noopener"
      style={{ display:'inline-flex', alignItems:'center', textDecoration:'none', boxSizing:'border-box', gap:11, padding:'10px 18px 10px 11px', borderRadius:999, fontWeight:600, fontSize:16, lineHeight:1, fontFamily:'-apple-system,system-ui,sans-serif', background:'#fff', border:'1px solid #e6e6e9', boxShadow:'0 1px 3px rgba(0,0,0,.12)', color:'#1d1d1f' }}
    >
      <span style={{ display:'inline-flex' }}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 230" width="36" height="41" style={{ display:'block' }}>
          <g>
      ...
      <span>Reporting by CrunchJunkie</span>
    </a>
  )
}

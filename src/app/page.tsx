...
const jsonLd = [
  ...
  serviceSchema({ name: 'SEO', description: 'Technical SEO, content and digital PR. We earn rankings the slow, honest way — and the same work compounds across AI search.', url: 'https://pmax.online/seo-company-mallorca/', serviceType: 'Search Engine Optimisation' }),

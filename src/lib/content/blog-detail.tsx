...

  {
    ...
    prose: (
      <>
        ...
        <p>Re-run the same 20 prompts every month. Track which answers now name you and which still don&rsquo;t. <a href="https://crunchjunky.io/">CrunchJunky</a> can automate this across engines &mdash; or do it by hand in a spreadsheet. What you don&rsquo;t measure, you can&rsquo;t move.</p>
...

  {
    ...
    prose: (
      <>
        ...
        <h3>5. Measure monthly</h3>
        <p>Re-run those same 20 prompts every month. Track which mentions appear, in what context, with what sentiment. <a href="https://crunchjunky.io/">CrunchJunky</a> can automate this &mdash; or you can do it manually for a few hours a month. Either way: if you don&rsquo;t measure it, you can&rsquo;t improve it.</p>
        <div className="prose-callout">
          <div className="prose-callout-kicker">The honest version</div>

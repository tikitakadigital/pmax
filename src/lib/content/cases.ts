...
export const cases: Case[] = [
  ...
  },
  {
    ...
    stamp: 'APR 2026',
    kicker: 'Education · Multi-location · Germany',
    title: 'Multi-location training school: 2.2× the leads at the same Google Ads budget',
    deck: 'Tracking rebuilt around real enquiries, then one brand and one generic campaign per location — for a course provider whose dashboard had been counting page views as conversions.',
    meta: ['Google Ads + Tracking', 'Education'],
    result: { num: '−55%', label: 'Cost per lead, YoY' },
    variant: 'is-violet',
    heroVariant: 'is-violet',
    services: ['Google Ads', 'Analytics'],
    stats: [
      { num: '2.2×', label: 'Leads at the same budget' },
      { num: '−55%', label: 'Cost per lead' },
      { num: '+114%', label: 'Non-brand leads' },
    ],
    client: 'Multi-location training school',
    sector: 'Education — course provider',
    year: '2026',
  },
  {
    slug: 'ledxpress',

...
export const es = {
  ...
  home: {
    ...
    processSteps: [
      { step: '01', word: 'Escuchar', time: '2 sem.', desc: 'Primero entendemos el negocio. Luego los datos, luego los canales. Las presentaciones vienen al final.' },
      { step: '02', word: 'Ordenar', time: '6 sem.', desc: 'Tracking, feeds, datos estructurados, fundamentos. El trabajo poco glamuroso del que depende todo lo demás.' },
      { step: '03', word: 'Crecer', time: '12 sem.+', desc: 'Las campañas escalan, los creativos encuentran su ritmo, el dashboard empieza a decir la verdad.' },
      { step: '04', word: 'Sostener', time: '∞', desc: 'SEO, visibilidad en IA, protección de marca. Un trabajo silencioso que se acumula durante años.' },
    ],

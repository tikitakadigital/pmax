...
export const es = {
  ...
  home: {
    ...
    workAside: 'Once proyectos con los números por delante. Sin métricas de vanidad — solo lo que apareció en la cuenta bancaria.',
  ...
  about: {
    ...
    casesText: <>Una selección de <a href="/es/cases/">casos de estudio</a> está disponible en nuestro archivo de trabajo — once proyectos con los números reales.</>,
  ...
  cases: {
    ...
    metaDesc: '11 casos de estudio: +365 % ingresos SEO, −93 % coste por lead, +307 % registros. Resultados reales de e-commerce, inmobiliaria, SaaS, retail y más.',
    eyebrow: 'Trabajo seleccionado · 2024–2026',
    title: <>Números reales<br />de clientes <em>reales</em>.</>,
    deck: 'Once proyectos donde el cambio correcto movió el negocio. Compartimos lo que construimos, lo que funcionó y — donde es útil — lo que no.',
    allKicker: 'Todo el trabajo · 2024–2026',
    allTitle: 'Once proyectos.',
    ...
    items: [
      ...
      { slug: 'training-school-google-ads', stamp: 'ABR 2026', kicker: 'Formación · Varias sedes · Alemania', title: 'Centro de formación con tres sedes: 2,2× más leads con el mismo presupuesto de Google Ads', deck: 'Primero, un tracking reconstruido en torno a solicitudes reales; después, una campaña de marca y otra genérica por sede — para un centro cuyo panel contaba visitas de página como conversiones.', result: { num: '−55 %', label: 'Coste por lead YoY' }, variant: 'is-violet' },
  ...
  caseDetail: {
    ...
    'training-school-google-ads': {
      metaTitle: 'Centro de formación — 2,2× leads con el mismo presupuesto de Google Ads | pmax',
      metaDesc: 'Un centro de formación con tres sedes en Alemania: tracking reconstruido en torno a solicitudes reales y una estructura de cuenta por sede. 250 leads verificados en cinco meses a 41 € cada uno, con el presupuesto del año anterior.',
      heroTitle: 'Mismo presupuesto, 2,2× más leads — reconstruir una cuenta de Google Ads con varias sedes empezando por el tracking.',
      heroDeck: 'A la cuenta no le faltaba presupuesto. Le faltaban datos fiables. Primero definimos qué cuenta como conversión, después reconstruimos la estructura y solo entonces dejamos que Smart Bidding hiciera su trabajo.',
      stats: [
        { num: '2,2×', label: 'Leads con el mismo presupuesto (mar–jul, YoY)' },
        { num: '−55 %', label: 'Coste por lead, 92 € → 41 €' },
        { num: '+114 %', label: 'Leads de búsquedas sin marca' },
        { num: '2,5×', label: 'Tasa de conversión, 1,1 % → 2,9 %' },
      ],
      prose: (<>
        <div className="case-brief"><p>Un centro de formación alemán con tres sedes que vende cursos prácticos: de los que la gente reserva después de comparar un puñado de proveedores locales. Google Search es su principal canal de captación: el interesado busca, llega a la página de un curso y envía una solicitud o reserva directamente. El encargo era fácil de formular y difícil de cumplir: más solicitudes reales, sin subir el presupuesto. Hemos anonimizado al cliente y omitido la marca, las ciudades y cualquier otro dato que permita identificarlo. Las cifras no se han tocado.</p></div>
        <section className="case-chapter"><span className="case-chapter-num">01</span><h2>El punto de partida: un panel en el que nadie podía confiar</h2><p>El primer problema no estaba en las campañas, sino en la configuración de conversiones. La cuenta contaba en parte las visitas de página como conversiones, mientras que algunas solicitudes reales ni siquiera se registraban. Las cifras eran, a la vez, infladas e incompletas, y ninguna tenía un valor asignado. Smart Bidding aprendía de una señal que mezclaba a quien había echado un vistazo a una página con quien quería reservar un curso.</p><p>La estructura tenía el mismo problema. Las campañas se habían ido acumulando con los años, el tráfico de marca y el genérico pasaban por las mismas campañas y muchos anuncios de las campañas antiguas estaban rechazados. Al desmontarlas, dos campañas saltaban a la vista:</p><ul><li>Una campaña de ámbito nacional, sin vínculo a ninguna sede, se llevaba cerca de una cuarta parte del presupuesto anual, a unos <strong>570 € por conversión</strong>.</li><li>Una sola campaña de ciudad se llevaba otra cuarta parte, a unos <strong>300 € por conversión</strong>.</li></ul><p>Entre las dos: la mitad del presupuesto para alrededor del 14 % de las conversiones. Y eso con la antigua definición de conversión, la que favorecía las cifras. Medidas contra solicitudes reales, salían aún peor paradas.</p></section>
        <section className="case-chapter"><span className="case-chapter-num">02</span><h2>Arreglar la medición antes de tocar las pujas</h2><p>Optimizar una cuenta con una señal rota solo te hace mejor en lo equivocado. Así que lo primero fue reconstruir el tracking en torno a las acciones que de verdad significan negocio:</p><ul><li><strong>Etiquetado del lado del servidor</strong>, para que las conversiones resistan mucho mejor los bloqueadores de anuncios, las restricciones de los navegadores y los huecos de consentimiento que un tracking solo en el navegador.</li><li><strong>Solo conversiones reales.</strong> Cuentan los envíos de formulario y otras acciones de solicitud genuinas. Las visitas de página, no.</li><li><strong>Un valor de conversión para cada lead</strong>, para que el algoritmo de pujas distinga una solicitud valiosa de una barata, en lugar de limitarse a contarlas.</li></ul><p>Por primera vez, la cuenta sabía cuánto valía un lead. Entre marzo y julio registró unos 13.000 € en valor de conversión. El año anterior, prácticamente nada.</p></section>
        <section className="case-chapter"><span className="case-chapter-num">03</span><h2>Reconstruir la estructura en torno a sedes e intención</h2><p>En febrero reorganizamos la cuenta según cómo busca la gente realmente un centro de formación local: por ubicación, y según si ya conoce la marca o no.</p><ul><li><strong>Una campaña de marca y otra genérica por sede</strong>, para que presupuesto, pujas y textos siguieran la demanda local en lugar de promediarse entre tres ciudades.</li><li><strong>Fuera el lastre.</strong> Se desactivaron la campaña nacional de cajón de sastre, los anuncios dinámicos de búsqueda, las campañas de vales regalo y una sede fuera del área de influencia principal.</li><li><strong>Sin cortes en la entrada de leads.</strong> Las campañas antiguas siguieron activas en paralelo con «Maximizar clics» hasta abril, mientras la nueva estructura acumulaba suficiente historial de conversiones para pujar bien.</li><li><strong>Temporada alta protegida.</strong> En junio y julio añadimos campañas con cuota de impresiones objetivo para mantener la visibilidad en las búsquedas clave cuando la demanda era máxima.</li></ul></section>
        <section className="case-chapter"><span className="case-chapter-num">04</span><h2>Resultados: de marzo a julio de 2026 frente a los mismos meses de 2025</h2><p>Comparamos de marzo a julio porque es el periodo en que la nueva estructura estuvo plenamente activa y cubre la misma temporada en ambos años. La inversión fue casi idéntica: 10.272 € frente a 10.552 €.</p><ul><li><strong>250 leads frente a 115</strong>: 2,2× más con el mismo presupuesto.</li><li><strong>Coste por lead un 55 % menor</strong>, de 92 € a 41 €.</li><li><strong>Tasa de conversión del 1,1 % al 2,9 %</strong>.</li><li><strong>Leads de búsquedas sin marca: +114 %</strong>, a unos 53 € cada uno en lugar de 118 €. El crecimiento no vino de gente que ya buscaba la marca.</li><li><strong>Mejor mes: mayo de 2026</strong>, con 31 € por lead y una tasa de conversión del 3,2 %, frente a 67 € un año antes.</li></ul><div className="prose-callout"><div className="prose-callout-kicker">Una nota sobre la comparación</div><p>Los dos años no se midieron igual. Las cifras de 2025 incluyen visitas de página contadas como conversiones y dejan fuera algunas solicitudes reales; las de 2026 cuentan solo solicitudes verificadas. Por eso, los porcentajes interanuales indican una dirección, no un valor exacto. Lo que no es una estimación: 250 solicitudes reales en cinco meses, cada una registrada con su valor, a 41 € cada una y con el presupuesto del año anterior.</p></div></section>
        <div className="case-takeaway"><span className="case-takeaway-kicker">Qué lo hizo funcionar</span><p>La mayoría de las cuentas de captación de leads que rinden poco no tienen un problema de pujas. Tienen un problema de medición que parece un problema de pujas. Si las visitas de página cuentan como conversiones, el algoritmo compra encantado más visitas de página. El orden importa: definir qué es un lead real, medirlo bien y con valor, reconstruir la estructura según cómo buscan de verdad los clientes y, solo entonces, pedirle a Smart Bidding que encuentre más.</p></div>
      </>),
    },
    ledxpress: {

  ...
  blogPostDetail: {
    ...
    'perplexity-visibility': {
      ...
      prose: (
        <>
          ...
          <p>Repite los mismos 20 prompts todos los meses. Controla qué respuestas ya te nombran y cuáles todavía no. <a href="https://crunchjunky.io/">CrunchJunky</a> automatiza esto entre motores, o hazlo a mano en una hoja de cálculo. Lo que no mides, no lo puedes mejorar.</p>
    ...
    'how-to-get-mentioned-by-chatgpt': {
      ...
      prose: (<>
        ...
        <p>Vuelve a ejecutar esas mismas 20 consultas cada mes. <a href="https://crunchjunky.io/">CrunchJunky</a> puede automatizarlo — o puedes hacerlo manualmente. De cualquier forma: si no lo mides, no puedes mejorarlo.</p>
        <div className="prose-callout">
          <div className="prose-callout-kicker">La versión honesta</div>

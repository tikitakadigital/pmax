...
export const de = {
  ...
  home: {
    ...
    workAside: 'Elf Kundenprojekte mit echten Zahlen. Keine Eitelkeitsmetriken — nur das, was am Ende auf dem Konto zu sehen war.',
  ...
  about: {
    ...
    casesText: <>Ausgewählte <a href="/de/cases/">Referenzen</a> finden Sie in unserem Arbeitsarchiv — elf Projekte mit echten Zahlen.</>,
  ...
  cases: {
    ...
    metaDesc: '11 Fallstudien: +365 % SEO-Umsatz, −93 % Kosten pro Lead, +307 % Anmeldungen. Echte Ergebnisse aus E-Commerce, Immobilien, SaaS, Einzelhandel und mehr.',
    eyebrow: 'Ausgewählte Referenzen · 2024–2026',
    title: <>Echte <em>Zahlen</em><br />von echten Kunden.</>,
    deck: 'Elf Projekte, bei denen die richtige kleine Änderung das Unternehmen bewegt hat. Wir zeigen, was wir gebaut haben, was funktioniert hat — und, wo es nützlich ist, was nicht.',
    allKicker: 'Alle Referenzen · 2024–2026',
    allTitle: 'Elf Projekte.',
    ...
    items: [
      ...
      { slug: 'training-school-google-ads', stamp: 'APR 2026', kicker: 'Bildung · Mehrere Standorte · Deutschland', title: 'Schulungsanbieter mit drei Standorten: 2,2× so viele Leads bei gleichem Google-Ads-Budget', deck: 'Erst das Tracking auf echte Anfragen umgebaut, dann je Standort eine Brand- und eine generische Kampagne — für einen Kursanbieter, dessen Dashboard Seitenaufrufe als Conversions gezählt hatte.', result: { num: '−55 %', label: 'Kosten pro Lead YoY' }, variant: 'is-violet' },
  ...
  caseDetail: {
    ...
    'training-school-google-ads': {
      metaTitle: 'Schulungsanbieter — 2,2× Leads bei gleichem Google-Ads-Budget | pmax',
      metaDesc: 'Ein Schulungsanbieter mit drei Standorten in Deutschland: Tracking auf echte Anfragen umgebaut, Kontostruktur je Standort neu aufgesetzt. 250 verifizierte Leads in fünf Monaten zu je 41 € — beim Budget des Vorjahres.',
      heroTitle: 'Gleiches Budget, 2,2× so viele Leads — ein Google-Ads-Konto mit mehreren Standorten, vom Tracking aus neu gebaut.',
      heroDeck: 'Dem Konto fehlte kein Budget. Ihm fehlten ehrliche Daten. Wir haben zuerst geklärt, was als Conversion zählt, dann die Struktur neu aufgebaut — und erst danach Smart Bidding die Zügel gelassen.',
      stats: [
        { num: '2,2×', label: 'Leads bei gleichem Budget (März–Juli, YoY)' },
        { num: '−55 %', label: 'Kosten pro Lead, 92 € → 41 €' },
        { num: '+114 %', label: 'Non-Brand-Leads' },
        { num: '2,5×', label: 'Conversion Rate, 1,1 % → 2,9 %' },
      ],
      prose: (<>
        <div className="case-brief"><p>Ein deutscher Schulungsanbieter mit drei Standorten, der praxisnahe Kurse verkauft — Kurse, die Interessenten buchen, nachdem sie eine Handvoll lokaler Anbieter verglichen haben. Google Search ist der wichtigste Akquisekanal: Interessenten suchen, landen auf einer Kursseite und schicken eine Anfrage oder buchen direkt. Das Briefing war schnell formuliert und schwerer umzusetzen: mehr echte Anfragen, ohne das Budget zu erhöhen. Wir haben den Kunden anonymisiert und Marke, Städte und alles andere weggelassen, was Rückschlüsse zulassen würde. Die Zahlen sind unverändert.</p></div>
        <section className="case-chapter"><span className="case-chapter-num">01</span><h2>Der Ausgangspunkt: ein Dashboard, dem niemand trauen konnte</h2><p>Das erste Problem lag nicht in den Kampagnen, sondern im Conversion-Setup. Das Konto zählte teilweise Seitenaufrufe als Conversions, während manche echten Anfragen überhaupt nicht erfasst wurden. Die gemeldeten Zahlen waren also gleichzeitig aufgebläht und unvollständig — und keine davon hatte einen Wert. Smart Bidding lernte aus einem Signal, das Menschen, die kurz eine Seite angesehen hatten, mit Menschen vermischte, die einen Kurs buchen wollten.</p><p>Die Struktur hatte dasselbe Problem. Über die Jahre hatten sich Kampagnen angesammelt, Brand- und Non-Brand-Traffic liefen durch dieselben Kampagnen, und in den älteren Kampagnen waren viele Anzeigen abgelehnt. Zwei Kampagnen fielen auf, sobald wir sie auseinandergenommen hatten:</p><ul><li>Eine bundesweite Kampagne ohne Standortbezug verbrauchte rund ein Viertel des Jahresbudgets — bei etwa <strong>570 € pro Conversion</strong>.</li><li>Eine einzelne Stadtkampagne verbrauchte ein weiteres Viertel — bei etwa <strong>300 € pro Conversion</strong>.</li></ul><p>Zusammen: rund die Hälfte des Budgets für etwa 14 % der Conversions. Und das nach der alten, schmeichelhaften Definition einer Conversion. Gemessen an echten Anfragen schnitten sie noch schlechter ab.</p></section>
        <section className="case-chapter"><span className="case-chapter-num">02</span><h2>Erst die Messung reparieren, dann die Gebote</h2><p>Wer ein Konto auf ein kaputtes Signal optimiert, wird nur besser im Falschen. Also haben wir zuerst das Tracking um die Aktionen herum neu aufgebaut, die tatsächlich Geschäft bedeuten:</p><ul><li><strong>Server-seitiges Tagging</strong>, damit Conversions Ad-Blocker, Browser-Beschränkungen und Consent-Lücken deutlich besser überstehen als bei reinem Browser-Tracking.</li><li><strong>Nur echte Conversions.</strong> Formularanfragen und andere echte Anfrage-Aktionen zählen. Seitenaufrufe nicht.</li><li><strong>Conversion-Werte für jeden Lead</strong>, damit der Gebotsalgorithmus eine wertvolle Anfrage von einer billigen unterscheiden kann, statt sie nur zu zählen.</li></ul><p>Zum ersten Mal wusste das Konto, was ein Lead wert ist. Von März bis Juli erfasste es rund 13.000 € Conversion-Wert. Im Vorjahr hatte es praktisch keinen erfasst.</p></section>
        <section className="case-chapter"><span className="case-chapter-num">03</span><h2>Die Struktur um Standorte und Suchintention neu bauen</h2><p>Im Februar haben wir das Konto so aufgebaut, wie Menschen tatsächlich nach einem lokalen Kursanbieter suchen: nach Standort — und danach, ob sie die Marke schon kennen.</p><ul><li><strong>Je Standort eine Brand- und eine generische Kampagne</strong>, damit Budget, Gebote und Anzeigentexte der lokalen Nachfrage folgen, statt über drei Städte gemittelt zu werden.</li><li><strong>Ballast abgeworfen.</strong> Die bundesweite Sammelkampagne, dynamische Suchanzeigen, Gutschein-Kampagnen und ein Standort außerhalb des Kerneinzugsgebiets wurden abgeschaltet.</li><li><strong>Keine Lücke im Lead-Fluss.</strong> Die alten Kampagnen liefen bis April parallel mit „Klicks maximieren“ weiter, während die neue Struktur genug Conversion-Historie aufbaute, um sauber bieten zu können.</li><li><strong>Hochsaison abgesichert.</strong> Im Juni und Juli kamen Kampagnen mit Ziel-Impressionsanteil dazu, um die Sichtbarkeit bei den wichtigsten Suchanfragen zu halten, wenn die Nachfrage am höchsten war.</li></ul></section>
        <section className="case-chapter"><span className="case-chapter-num">04</span><h2>Die Ergebnisse: März bis Juli 2026 im Vergleich zu denselben Monaten 2025</h2><p>Wir vergleichen März bis Juli, weil die neue Struktur in diesem Zeitraum vollständig live war und er in beiden Jahren dieselbe Saison abdeckt. Die Ausgaben waren nahezu identisch: 10.272 € gegenüber 10.552 €.</p><ul><li><strong>250 Leads statt 115</strong> — 2,2× so viele bei gleichem Budget.</li><li><strong>Kosten pro Lead um 55 % gesenkt</strong>, von 92 € auf 41 €.</li><li><strong>Conversion Rate von 1,1 % auf 2,9 %</strong>.</li><li><strong>Non-Brand-Leads +114 %</strong>, zu rund 53 € statt 118 € pro Lead. Das Wachstum kam also nicht von Menschen, die ohnehin schon nach der Marke gesucht haben.</li><li><strong>Bester Monat: Mai 2026</strong> mit 31 € pro Lead und 3,2 % Conversion Rate — gegenüber 67 € ein Jahr zuvor.</li></ul><div className="prose-callout"><div className="prose-callout-kicker">Ein Hinweis zum Vergleich</div><p>Die beiden Jahre wurden nicht gleich gemessen. Die Zahlen für 2025 enthalten Seitenaufrufe, die als Conversions gezählt wurden, und es fehlen manche echte Anfragen; 2026 zählen ausschließlich verifizierte Anfragen. Die prozentualen Veränderungen sind deshalb als Richtung zu lesen, nicht als exakter Wert. Was keine Schätzung ist: 250 echte Anfragen in fünf Monaten, jede mit Wert erfasst, zu je 41 € — beim Budget des Vorjahres.</p></div></section>
        <div className="case-takeaway"><span className="case-takeaway-kicker">Was es zum Erfolg gemacht hat</span><p>Die meisten schwachen Lead-Gen-Konten haben kein Gebotsproblem. Sie haben ein Messproblem, das wie ein Gebotsproblem aussieht. Wenn Seitenaufrufe als Conversions zählen, kauft der Algorithmus fröhlich mehr Seitenaufrufe. Die Reihenfolge entscheidet: festlegen, was ein echter Lead ist, ihn sauber und mit Wert erfassen, die Struktur danach ausrichten, wie Kunden tatsächlich suchen — und erst dann Smart Bidding mehr davon finden lassen.</p></div>
      </>),
    },
    ledxpress: {
  ...
  prose: (
    ...
    'google-ads-mallorca': {
      ...
      prose: (<>
        ...
        <p>Unsere <a href="/de/services/google-ads/">Google Ads &amp; Performance Max Leistung</a> — gebaut für Mallorcas mehrsprachige, saisonale Nachfrage. Auf der Suche nach einer Agentur und unsicher, was zu bewerten ist? Lesen Sie unseren Leitfaden zur <a href="/de/blog/google-ads-agency-mallorca/">Auswahl einer Google Ads Agentur auf Mallorca</a>. Kampagnen in ganz Spanien? Sehen Sie unsere <a href="/de/google-ads-agentur-spanien/">Google Ads Agentur Spanien</a>.</p>
        <h2>Brauchen Sie dabei Unterstützung?</h2>
    ...
    'google-ads-agency-mallorca': {
      title: 'Google Ads Agentur Mallorca: Was Sie prüfen sollten, bevor Sie unterschreiben',
      toc: ['Was Mallorca wirklich anders macht', 'Was eine gute Agentur leisten muss', 'Zahlen aus echten Accounts', 'Die entscheidende Frage vor Vertragsschluss'],
      prose: (<>
        <p>Google-Ads-Agenturen, die Mallorca sagen, gibt es viele. Die meisten sitzen auf dem Festland und haben den Markt noch nie von innen erlebt. Andere sitzen direkt auf der Insel, verkaufen aber dasselbe Paket: Kampagnen aufsetzen, monatliches PDF, Feedback-Call. Gleiche Struktur wie für ein Unternehmen in München.</p>
        <p>Das Problem: Mallorca ist kein München. Der Markt hat echte Besonderheiten, die nur ein Team kennt, das täglich damit arbeitet.</p>
        <h2>Was Mallorca wirklich anders macht</h2>
        <p>Drei Faktoren bestimmen, ob eine Google-Ads-Kampagne hier funktioniert oder nur läuft:</p>
        <ol>
          <li><strong>Mehrsprachigkeit als Kernaufgabe.</strong> Ihre Kunden suchen auf Deutsch, Spanisch, Englisch — manchmal dieselbe Person in derselben Entscheidungsphase. Eine Kampagne, die nur auf Deutsch aufgesetzt ist, verliert 40&ndash;60&nbsp;% der kommerziellen Suchabsicht. Die meisten Agenturen haben weder die Kapazität noch die sprachliche Kompetenz, Kampagnen in allen relevanten Sprachen sauber aufzubauen.</li>
          <li><strong>Extreme Saisonalität.</strong> Zwischen Juni und September generieren die meisten Gastronomiebetriebe und Tourismusbetriebe auf Mallorca 50&ndash;70&nbsp;% ihres Jahresumsatzes. Eine Kampagne mit gleichmäßig verteiltem Jahresbudget vernichtet Rendite in der Nebensaison. Bidding-Strategien müssen an der echten Nachfragekurve ausgerichtet sein.</li>
          <li><strong>Falsche Standard-Geo-Einstellung.</strong> Google Ads liefert standardmäßig mit &bdquo;Präsenz oder Interesse&ldquo;. Das bedeutet: Anzeigen für jeden in Deutschland, der sich jemals für Mallorca interessiert hat. Für einen lokalen Dienstleister ist das herausgeworfenes Geld. Diese Einstellung muss in der ersten Woche geändert werden. Viele Agenturen haben das noch nicht getan.</li>
        </ol>
        <h2>Was eine gute Google Ads Agentur für Mallorca leisten muss</h2>
        <p>Drei Fragen, die eine kompetente Agentur von einer mittelmäßigen trennen:</p>
        <p><strong>Fragen Sie nach dem CPC-Aufschluss nach Sprache und Monat.</strong> Wer diese Zahl nicht parat hat, verwaltet den Account — steuert ihn aber nicht.</p>
        <p><strong>Fragen Sie nach der Vergütungsstruktur.</strong> Agenturen, die einen Prozentsatz der Werbeausgaben berechnen, haben ein wirtschaftliches Interesse an mehr Budget &mdash; nicht an effizienterer Nutzung. Festpreise bringen die Interessen beider Seiten in Deckung. Nicht jede Agentur arbeitet so. Es lohnt sich, direkt zu fragen.</p>
        <p><strong>Fragen Sie, was das Conversion-Tracking abdeckt.</strong> Eine vollständige Antwort nennt: Formulare, Anrufe, Ladenbesuche (Googles Store-Visits-Conversion ist kostenlos und wird selten genutzt) und &mdash; falls ein CRM vorhanden ist &mdash; Offline-Conversions. Eine vage Antwort ist ein Warnsignal.</p>
        <h2>Zahlen aus echten Accounts, die wir auf Mallorca betreuen</h2>
        <p>Diese Werte stammen aus realen Accounts, Q1&ndash;Q2 2026:</p>
        <ul>
          <li>Durchschnittlicher CPC im Gastgewerbe Mallorca (Deutsch&nbsp;+ Englisch): 0,67&ndash;1,40&nbsp;€ je nach Saison und Match-Type</li>
          <li>Durchschnittliche Conversion-Rate bei Immobilien-Lead-Formularen: 2,8&ndash;5,1&nbsp;%</li>
          <li>Rückgang des Streuverlusts nach Wechsel auf &bdquo;Nur Präsenz&ldquo;: typischerweise 35&ndash;45&nbsp;% weniger Impressionsvolumen, Cost per Conversion im Schnitt 28&nbsp;% niedriger</li>
          <li>Mindestzeit bis die Datenbasis belastbar ist: 6&ndash;8 Wochen in einem lokalen Markt mit niedrigem Suchvolumen</li>
        </ul>
        <h2>Die entscheidende Frage vor Vertragsschluss</h2>
        <p>Bitten Sie die Agentur, konkret zu erklären, wie sie eine Kampagne für Ihr Kundenprofil aufbauen würde. Nicht allgemein. Für Ihren spezifischen Kundentyp, in Ihrer Region, in Ihren Sprachen.</p>
        <p>Wenn die Antwort vage bleibt &mdash; &bdquo;wir richten Google Ads ein und optimieren laufend&ldquo; &mdash; dann haben Sie Ihre Antwort.</p>
        <p>Weiterführende Lektüre: unser <a href="/de/services/google-ads/">Google Ads Service</a>, unser <a href="/de/blog/google-ads-mallorca/">Targeting-Leitfaden für Mallorca</a> und die <a href="/de/blog/how-to-advertise-business-mallorca/">vollständige Anleitung zur digitalen Werbung auf Mallorca</a>.</p>
        <h2>Brauchen Sie dabei Unterstützung?</h2>
        <p>Falls Ihnen das oben Genannte bekannt vorkommt, <a href="/de/contact/?topic=google-ads-agency-mallorca">schildern Sie uns kurz Ihre Situation</a> und wir melden uns innerhalb eines Werktages. Das erste Gespräch: 30 Minuten, auf unsere Rechnung.</p>
      </>),
    },
